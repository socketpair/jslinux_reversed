...
PIC_sub_std.prototype.reset = function () {
    this.last_irr = 0;
    this.irr = 0;
    this.imr = 0;
    this.isr = 0;
...
PIC_sub_std.prototype.set_irq1 = function (Tg, Rf) {
    var xc;
    xc = 1 << Tg;
    if (Rf) {
...
PIC_sub_std.prototype.get_priority = function (xc) {
    var Ug;
    if (xc == 0)return-1;
    Ug = 7;
...
PIC_sub_std.prototype.get_irq = function () {
    var xc, Vg, Ug;
...
PIC_sub_std.prototype.intack = function (Tg) {
    if (this.auto_eoi) {
...
PIC_sub_std.prototype.ioport_write = function (ia, ja) {
    var Ug;
    ia &= 1;
    if (ia == 0) {
        if (ja & 0x10) {
...
PIC_sub_std.prototype.ioport_read = function (Wg) {
    var ia, Rg;
    ia = Wg & 1;
    if (ia == 0) {
...
function PIC_std(Pg, Yg, Wg, Zg) {
    this.pics = new Array();
    this.pics[0] = new PIC_sub_std(Pg, Yg);
    this.pics[1] = new PIC_sub_std(Pg, Wg);
...
PIC_std.prototype.update_irq = function () {
    var ah, Tg;
...
PIC_std.prototype.set_irq = function (Tg, Rf) {
    this.pics[Tg >> 3].set_irq1(Tg & 7, Rf);
    this.update_irq();
};
PIC_std.prototype.get_hard_intno = function () {
    var Tg, ah, intno;
    Tg = this.pics[0].get_irq();
    if (Tg >= 0) {
